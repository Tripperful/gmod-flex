...
local propGroups = {
  {
    'Size',
    { prop = 'w', control = PROPWANG, label = 'width' },
    { prop = 'wMin', control = PROPWANG, label = 'min-width' },
    { prop = 'wMax', control = PROPWANG, label = 'max-width' },
    { prop = 'wAuto', control = PROPBOOL, label = 'auto-width' },
    { prop = 'h', control = PROPWANG, label = 'height' },
    { prop = 'hMin', control = PROPWANG, label = 'min-height' },
    { prop = 'hMax', control = PROPWANG, label = 'max-height' },
